...
Gem::Specification.new do |s|
  s.name                   = 'sensu-plugins-google-spreadsheet'
  s.version                = SensuPluginsGoogleSpreadsheet::VERSION
  s.authors                = ["Yieldbot, Inc. and contributors"]
  s.email                  = '<sensu-users@googlegroups.com>'
  s.homepage               = 'https://github.com/sensu-plugins/sensu-plugins-google-spreadsheet'
  s.summary                = ''
  s.description            = ''
  s.license                = 'MIT'
